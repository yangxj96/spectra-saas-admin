  ...
  <div style="height: 94%">
    ...
    <el-row style="height: calc(100% - 100px)">
      <el-table :data="table_data" stripe border height="100%" style="width: 100%">
        ...
        <el-table-column label="执行次数" prop="execute_count" width="100" align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column label="完成次数" prop="finish_count" width="100" align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column label="创建人员" prop="created_name" width="100" align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column label="创建时间" prop="created_datetime" width="180" align="center"
                         :show-overflow-tooltip="true" />
    ...
    <!-- XML预览弹框 -->
    <el-dialog v-model="dialog.preview"
...
export default defineComponent({
  ...
  methods: {
    ...
    // 格式化XML文本
    handleXMLFormatting(content: string) {
      return vkbeautify.xml(content, 50);
    },
    // 显示流程的XML和流程图
    handleShowDetails(row: any) {
...
:deep(.el-tabs__content), :deep(.el-tab-pane), :deep(.el-tabs) {
  width: 100%;
  height: 100%;
}
